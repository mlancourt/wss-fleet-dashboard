...
## Write model (fifteen actions — nine through schema 3, three lead actions at schema 5, `doc_attach` at schema 6, `rental_update` at D64, `work_order` at D65 — exactly these, nothing more)
