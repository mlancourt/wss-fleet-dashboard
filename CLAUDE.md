...
// D68 — parts[] lines on OPEN / ADD-PARTS may carry "source":"VENDOR|SHOP-STOCK|WARRANTY" (absent = VENDOR). Use from stock (service + owner; REQUESTED -> DELIVERED, no PO trail):
{"action":"work_order","payload":{"action":"PART-STATE","work_order":"W1001","line":1,"source":"SHOP-STOCK","note":null}}
...
{"action":"inspection","payload":{"action":"SAVE","inspection":"I1001","machine_class":"SWEEPER|SCRUBBER","body_style":"WALK-BEHIND|RIDER|STAND-ON","battery":{"type":"WET|AGM|LITHIUM","voltage":24,"pack":"4x6V|2x12V|3x12V|6x6V|null"},"readings":{"hours_key":412.5,"hours_traction":null,"hours_scrub":null,"main_broom_pct":null,"brush1_pct":60,"brush2_pct":60,"brushes_rotated":true},"cells":[{"battery":1,"cell":"A","sg":1.265,"clarity":"CLEAR|CLOUDY|PARTICULATE|DARK","level":"OVERFILLED|FULL|LOW|DRY"}],"items":[{"id":"ctl.key_switch","result":"IN-SPEC|REPAIR|PROBLEM|N/A","note":null},{"id":"deck.curtains","result":"GOOD|WORN|REPLACE|N/A","note":null}],"comments":null}}
