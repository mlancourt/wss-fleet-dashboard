...
## Write model (fourteen actions — nine through schema 3, three lead actions at schema 5, `doc_attach` at schema 6, `rental_update` at D64 — exactly these, nothing more)
