...
2. **Category → unit list** (top line = make & model, e.g. "Factory Cat Model 34"; sub-line = serial · asset # · location; chips for state + readiness) **→ unit detail** (everything: specs, cost/book/ask — **no floor price (D16)**, agreement + rate + last-invoiced period, reservation, readiness note, hours). Two levels, never more.
